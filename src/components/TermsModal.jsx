      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            {/* Title */}
            <h2 className="text-3xl  text-[#ffffff] mb-6 text-center">
              Terms & Conditions
            </h2>
            ...
            <div className="text-sm text-gray-300 leading-relaxed space-y-4 pr-2">
              ...
              <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://hashforgamers.co.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
              <p>The Platform is owned by Hashforgamers Pvt Ltd, a company incorporated under the Companies Act, 1956 with its registered office at A-104 Asmita Garden -1 Poonam Sagar Mira Road Mumbai, Mumbai, India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
